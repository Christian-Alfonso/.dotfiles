...
# Get VSCode binary location for installing extensions
...
# Open VSCode at least once initially to let it create those paths
...
if (!$NoVSCodeInsiders) {
    ...
    # Get VSCode Insiders binary location for installing extensions
    $VSCodeInsiders = "$env:LOCALAPPDATA\Programs\Microsoft VS Code Insiders\bin\code-insiders.cmd"
    ...
    # Open VSCode Insiders at least once initially to let it create those
